...
class MoneyTextWatcherPixFragment(editText: EditText, private val pixValueRequestViewModel: PixValueRequestViewModel)
    : TextWatcher {
    ...
    override fun afterTextChanged(editable: Editable?) {
        ...
        //pixValueRequestViewModel.pixValue = parsed.toDouble()
